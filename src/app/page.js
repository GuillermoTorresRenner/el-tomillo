	...
	return (
		<div className="">
			...
			<section className='flex flex-col justify-center items-center bg-white px-16 my-20'>
				...
				<strong>Nuestro propósito es</strong> <i> conectar a las personas con la naturaleza,</i> <strong> en el ritmo de la ciudad.</strong>
				</span>

				<span className='text-primary text-center text-caption md:text-subhead p-8'>
				La naturaleza tiene la máxima sabiduría y diseñar en pos de los propios recursos que ella ofrece, es parte de nosotros.
				</span>
			...
			<section id='historia' className='flex flex-col-reverse md:flex-row justify-center items-center bg-primary bg-[url("/images/leaf_pattern_light.svg")] bg-auto bg-repeat py-0 md:py-8 my-12'>
				...
				<div className='flex flex-col justify-center items-center md:items-start my-8 px-12 w-full md:w-1/2'>
					...
					<span className='text-primary text-start text-h2 font-merryweather font-bold mx-4 my-4 md:mx-0'>Nuestra historia</span>

					<p className='text-primary text-center md:text-start text-subhead font-merryweather mx-4 my-4 md:mx-0'>Soy Laura, fundadora de  <strong><i>El Tomillo Espacio Agrourbano.</i></strong> Este proyecto nació de mi deseo personal de transformar mis hábitos diarios hacia un <strong><i>estilo de vida más sostenible.</i></strong></p>

					<span className='hidden md:block text-primary text-center md:text-start text-button mx-4 my-4 md:mx-0'>
					Trabajo con un <strong><i>enfoque agrourbano</i></strong> que se refleja en cada uno de mis proyectos. Así sembré El Tomillo Espacio Agrourbano, para que sea la raíz de una visión: un espacio en el que la naturaleza y la ciudad coexisten, creando armonía entre belleza y funcionalidad.
					</span>

					<div className='w-full flex justify-center md:justify-start items-center'>
						<a href="/sobremi" target="_self" 
							className='block w-full sm:w-3/5 md:w-2/4 text-button font-urbanist hover:text-primary bg-transparent hover:bg-secondary border border-primary rounded rounded-lg mx-auto px-6 py-2 my-2'>
				...
				<div className='flex flex-col justify-center items-center px-0 md:px-12 w-full md:w-1/2'>
					<Image className='block md:hidden rounded rounded-0 md:rounded-2xl m-0 md:m-4' src='/images/inicio/inicio_historia_imgH.png' alt='' width={700} height={700} />
					<Image className='hidden md:block rounded rounded-0 md:rounded-2xl m-0 md:m-4' src='/images/inicio/inicio_historia_imgV.png' alt='' width={700} height={700} />
				</div>
			...
			<section id="servicios" className='my-12 px-8'>
				...
				<div className='flex flex-col justify-center items-center mb-6'>
					...
					<span className='text-center text-h2 w-4/5 md:w-2/5 font-merryweather font-bold'>Contamos con servicios diseñados para cada usuario</span>
				</div>
				...
				<a href="/servicios"
					target="_self" 
					className='block w-1/2 sm:w-3/5 md:w-1/4 text-button font-urbanist hover:text-primary bg-transparent hover:bg-secondary border border-primary rounded rounded-lg mx-auto px-6 py-2 my-2'>
			...
			<section id="experiencia" className='hidden md:block relative my-12 overflow-hidden'>
				...
				<div className='absolute w-full sm:w-3/4 md:w-2/5 -bottom-5 right-0 bg-primary opacity-90 flex flex-col p-16 rounded rounded-s-3xl'>
					...
					<a href="/experiencias"
						target="_blank" 
						className='block w-4/5 sm:w-3/5 md:w-1/2 text-button text-white hover:text-primary font-urbanist bg-transparent hover:bg-secondary border border-white rounded rounded-lg mx-auto px-6 py-2 my-2'>
			...
			<section id="proyectos" className='relative my-12 overflow-hidden'>
				...
				<div className='flex flex-col justify-center items-center'>
					...
					<span className='text-center text-h2 w-4/5 md:w-2/5 font-merryweather font-bold'>Conoce los proyectos realizados en <strong><i>El Tomillo</i></strong></span>
				</div>
				...
				<a href="https://wa.me/5492615970583?text=Quiero%20saber%20más%del%Tomillo"
					target="_blank" 
					className='block w-1/2 sm:w-3/5 md:w-1/4 text-button font-urbanist hover:text-primary bg-transparent hover:bg-secondary border border-primary rounded rounded-lg mx-auto px-6 py-2 my-2'>
					<p className='text-center'>Más información</p>
				</a>
			...
			<section id="recursos" className='bg-primary my-12 p-8'>
				...
				<div>
					<a href="/recursos"
						target="_self" 
						className='block w-1/2 sm:w-3/5 md:w-1/4 text-white text-button font-urbanist hover:text-primary bg-transparent hover:bg-secondary border border-white rounded rounded-lg mx-auto px-6 py-2 my-2'>
