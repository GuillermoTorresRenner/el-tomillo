        ...
        <div className="">
            ...
            <section className="my-12 px-8">
                ...
                <div className="flex justify-center items-center mb-6">
                    <a href="/servicios" target="_self" className="text-button font-urbanist hover:text-primary bg-transparent hover:bg-secondary border border-primary rounded-lg mx-auto px-6 py-2 my-2" >
            ...
            <section id="proyectos" className="relative my-12 overflow-hidden">
                ...
                <div className="flex flex-wrap justify-center p-8 gap-8">
                    ...
                    <FlipCard2
                        ...
                        description={
                            "Vendé tus plantas con nosotras. Podés traernos tus plantas y utilizar nuestras redes para la venta, fomentando una economía más colaborativa. Mientras, nosotras las cuidamos en el ro."
                        }
                    />
                ...
                <div className="flex justify-center">
                    <a href="https://wa.me/5492615970583?text=Quiero%20saber%20m%C3%A1s%20del%20espacio%20agrourbano%20El%20Tomillo" target="_self" className="text-button text-primary hover:text-primary font-urbanist bg-transparent hover:bg-secondary border border-primary rounded-lg m-auto px-6 py-2 my-2">
            ...
            <section id="recursos" className="bg-primary my-12 p-8">
                ...
                <div className="flex justify-center">
                    <a href="/recursos" target="_self" className="block text-white text-button font-urbanist hover:text-primary bg-transparent hover:bg-secondary border border-white  rounded-lg mx-auto px-6 py-2 my-2" >
