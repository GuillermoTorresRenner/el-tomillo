    ...
    return (
        <div className="">
            <section className="flex flex-col md:flex-row justify-center items-center -100 my-10 p-8">
                ...
                <div>
                    <Image className="rounded rounded-2xl" src="/images/sobremi/img_sobremi_mlc.png" alt="" width={600} height={600} />
                </div>
                ...
                <div className="w-full flex flex-col justify-center md:justify-start items-center md:w-1/3 px-8">
                    ...
                    <div className="w-full flex md:hidden justify-center items-center mt-4">
                        <a href="https://wa.me/5492615970583?text=Quiero%20saber%20m%C3%A1s%20del%20espacio%20agrourbano%20El%20Tomillo" target="_self" className="block text-button font-urbanist hover:text-primary bg-transparent hover:bg-secondary border border-primary rounded-lg px-6 py-2 my-2" > <p>Te cuento un poco sobre mí</p> </a>
                    </div>
                    ...
                    <div className="w-full flex flex-col justify-center items-center md:items-start my-8">
                        <p className='block md:hidden text-center'>
                            ¡Hola! Soy Laura, creadora de <strong><i>El Tomillo Espacio Agrourbano</i></strong>, un espacio donde la naturaleza y la ciudad coexisten.
                            <br/>
                            Me motiva el diseño de espacios verdes con una impronta ambiental.
                            <br/>
                            Mi sueño es que las ciudades puedan tener jardines y huertas urbanas al alcance de todos. Me encanta mi trabajo que combina la pasión por el diseño con habilidades para la gestión de proyectos.
                        </p>
            ...
            <section className='flex flex-col justify-center items-center bg-[url("/images/leaf_pattern_light.svg")] bg-cover bg-repeat py-8 my-10'>
                <div className="w-full">
                    <span className="block text-center text-subhead">
                        Mi compromiso
                    </span>
                ...
                <div className="flex flex-wrap justify-center">
                    <div className="flex">
                        <Card
                            iconUrl={
                                '/images/sobremi/card_cultivation_icon.svg'
                            }
            ...
            <section id="ideologia" className='flex flex-col-reverse md:flex-row justify-center items-center bg-primary bg-[url("/images/leaf_pattern_dark.svg")] bg-auto bg-repeat py-0  md:py-8 my-20' >
                ...
                <div className="flex flex-col justify-start items-center md:items-start my-8 px-12 w-full md:w-1/2">
                    ...
                    <p className="text-white text-center md:text-start font-bold text-subhead font-merryweather mx-4 my-4 md:mx-0">
                        Mi enfoque de trabajo se centra en el concepto de
                        circularidad en todos sus aspectos, desde materias
                        primas hasta relaciones humanas.
                    </p>
...
<<<<<<< HEAD
        ...
        <div className="w-full flex flex-col justify-center md:justify-start items-center md:w-1/3 px-8">
          ...
          <div className="w-full flex flex-col justify-center items-center md:items-start my-8">
            <p className="text-button md:text-caption text-center md:text-start">
              {" "}
      ...
      <section
        id="mi_compromiso"
        className='flex flex-col justify-center items-center bg-[url("/images/leaf_pattern_light.svg")] bg-cover bg-repeat py-8 my-10'
      >
        <div className="w-full">
...
=======
export default Sobremi
>>>>>>> 4a843da32bf5c9e85ad93eb8c8bd2b807092cd1d
